  ...
  \begin{overlayarea}{\textwidth}{0.8\textheight}
    \only<1|handout:1>
    {
      \begin{center}
        ...
        \vspace{2ex}
        \includegraphics[width=0.95\textwidth]{figs/Kenji_Glue_Crop3}
        \vspace{3ex}
    ...
    {
      \begin{center}
        \includegraphics[width=0.6\textwidth]{figs/0mT_zeeman_Fangohr_Ferromagnetic_Sphere}
    ...
    {
      \begin{center}
        \includegraphics[width=0.8\textwidth]{figs/3d_landscape_samples_NieldDunes}
    ...
    {
      \begin{center}
        \includegraphics[width=0.67\textwidth]{figs/collapse6}
    ...
    {
      \begin{center}
        \includegraphics[width=0.95\textwidth]{figs/QuadPic1}
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[width=0.9\textwidth]{figs/ModelMethodReality}
  \end{center}
